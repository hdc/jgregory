...
<SCRIPT runat="merc_server">
	...
	var SITEMGR_HTTPS_WEBSERVER="judygregory.com";
	...
	var SITE_HTTPS_WEBSERVER="judygregory.com";
	var SITE_HTTPS_PRIVATE_HTDOCS_ALIAS="/mpc/docs/";
	var SITE_HTTPS_PRIVATE_CGIBIN_ALIAS="/cgi-local/mpc/";
	var SecureSiteUrl="http://judygregory.com:80/cgi-local/mpc/PowerCommerce.cgi";
	var SecureBaseHref="http://judygregory.com:80/mpc/docs/SiteMgr/";

	// images.cfg entries
	var SecureRelURLPath = "/mpc/docs/images/";
	
	// PageEditor.cfg entries
	var SecurePublishBaseHref = "http://judygregory.com:80/mpc/docs/Site/";
	var SecurePreviewBaseHref = "http://judygregory.com:80/mpc/docs/Site/Preview/";
	var SecurePublishLinkHref = "http://judygregory.com:80/mpc/docs/Site/";
	var SecurePreviewLinkHref = "http://judygregory.com:80/mpc/docs/Site/Preview/";
